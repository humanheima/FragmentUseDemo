...
public class ForthLazyFragment extends BaseLazyFragment {
    ...
    public ForthLazyFragment() {
        // Required empty public constructor
    }

    public static ForthLazyFragment newInstance(int id) {
        ForthLazyFragment fragment = new ForthLazyFragment();
