...
public class ThirdLazyFragment extends BaseLazyFragment {
    ...
    public ThirdLazyFragment() {
        // Required empty public constructor
    }

    public static ThirdLazyFragment newInstance(int id) {
        ThirdLazyFragment fragment = new ThirdLazyFragment();
